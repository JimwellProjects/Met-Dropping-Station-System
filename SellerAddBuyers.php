...
<header>
			...
			<nav style="background:	#202020;">
					  ...
					  <a href="SellerAddBuyers.php"  style="border:solid; height: 5px; border-top: hidden;border-right: hidden;border-left:hidden; ">Add Buyers</a>
	...
	<form action="SellerAddBuyers.php" method="POST"  style="width: 33%; height: 100%; background:#ffbb34; border-radius: 10px; box-shadow: -1px -1px 20px -1px rgba(0,0,0,0.52);-webkit-box-shadow: -1px -1px 20px -1px rgba(0,0,0,0.52);-moz-box-shadow: -1px -1px 20px -1px rgba(0,0,0,0.52); margin-left: 35%; margin-right: 35%; margin-top: 6%;">
						...
						$seller_Fullname = $_POST['sellers'];
							...
							if (mysqli_connect_error()) {
								...
								if($conn->query($sql)) {
									...
									<div align='center'><p style='color:white; text-align:center; margin-top:3%; background:gray;  width:50%; border-radius:5px;'>New Added Buyer</p></div>";
								}
								else{
	...
	<tr>
		<td>
			<h3 style="margin-top: 3%; margin-left: 3%;">Seller Name:</h3>
		</td>
	</tr>
		...
		<td rowspan="1" width="30%" style="margin-left: 3%;">
			<select   name="sellers" style="width: 60%;height: 35px;border-radius: 5px; border:solid; border-width: 1px;
		 		border-color: #A9A9A9; margin-left: 3%; border:hidden;">
					...
					$sql = "SELECT Seller_Fullname FROM sellerprofile WHERE Seller_Fullname='$CustomerFullname'";
